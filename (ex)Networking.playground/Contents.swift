...
// CRUD 네트워킹
                                 ...
                                 // - ex) 인스타그램
// ⭐️ GET 메서드 (서버에서 데이터 읽어오기) - ex) 내가 팔로잉하는 사람들의 게시글 보기
// ⭐️ POST 메서드 (서버에 내가 원하는 new데이터 업로드 하기) - ex) 나의 포스트 올리기 / 다른 사람의 게시물에 댓글 달기 / 서비스 가입하기
// ⭐️ PUT 메서드 (서버에 현존하는 데이터 업데이트 하기) - ex) 나의 포스트 수정하기 / 다른 사람의 게시물에 좋아요 누르기 / 나의 정보 수정
// ⭐️ DLETE 메서드 (서버에 현존하는 데이터 삭제하기) - ex) 나의 포스트 삭제하기
...
// ===========================================================================================================================================================
// ⭐️ POST메서드(서버에 내가 원하는 new데이터 업로드하기)
// ex) 인스타그램 - 나의 포스트 올리기 / 다른 사람의 게시물에 댓글 달기 / 서비스 가입하기
func postMethod() {
...
// ===========================================================================================================================================================
// ⭐️ PUT메서드(서버에 현존하는 데이터 업데이트하기)
// ex) 인스타그램 - 나의 포스트 수정하기 / 다른 사람 게시물의 좋아요 누르기 / 나의 정보 수정
func putMethod() {
